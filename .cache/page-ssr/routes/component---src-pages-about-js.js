...
const AboutPage = () => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
  className: "container py-5"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", {
  className: "mb-4 text-center"
}, "Acerca del Blog"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
  className: "lead"
}, "Bienvenido a nuestro blog. Aqu\xED compartimos las \xFAltimas noticias y actualizaciones sobre deportes, con un enfoque especial en el f\xFAtbol colombiano. Nuestro objetivo es brindarte contenido relevante y actualizado, con un an\xE1lisis detallado y opiniones informadas."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Este blog se actualiza regularmente con art\xEDculos nuevos, cr\xF3nicas de partidos y entrevistas exclusivas. Nuestro equipo de redactores trabaja para asegurarse de que siempre est\xE9s al tanto de lo m\xE1s importante."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Si eres un fan\xE1tico del f\xFAtbol o simplemente te gusta estar informado, este es el lugar perfecto para ti. \xA1Esperamos que disfrutes el contenido!"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
  to: "/",
